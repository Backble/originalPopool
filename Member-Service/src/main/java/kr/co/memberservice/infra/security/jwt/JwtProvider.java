...
import kr.co.memberservice.error.exception.NotFoundException;
import kr.co.memberservice.error.exception.UnauthorizedException;
...
public class JwtProvider {
    ...
    public String createAccessToken(String refreshToken){
        MemberMstEntity memberMstEntity = findMemberByToken(refreshToken);
     ...
     */
    public MemberMstEntity findMemberByToken(String token){
